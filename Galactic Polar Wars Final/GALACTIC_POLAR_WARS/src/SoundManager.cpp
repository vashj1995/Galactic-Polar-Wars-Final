...
int SoundManager::checkMusic()		//I needed this to play the loop after the riser. 
{									//Might come in handy later, e.g. changing from level music to boss battle music.	-Niko
